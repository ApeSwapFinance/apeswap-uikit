...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      <div
        class="sc-iNWwEs blcqBr"
      >
        <nav
          class="sc-eKszNL dZaEmB"
        >
          <div
          ...
          >
            ...
            <button
              ...
              class="sc-jSMfEi iQNWPz sc-iTONeN ivUTOd"
              type="button"
            >
              <svg
                class="sc-dkzDqf jbfioX"
        ...
        <div
          class="sc-olbas jwShQk"
        >
          <div
            class="sc-BeQoi hvarlQ"
          >
            <div
              class="sc-efBctP bjfOlD"
              role="button"
            >
              <a
                href="/swap"
            ...
            >
              ...
              >
                ...
                <div
                  class="sc-gsnTZi sc-lbxAil jjsmnk ejsFxe"
                >
                  <button
                    class="sc-jSMfEi iHPyqh sc-jdAMXn hQiwiJ"
                    type="button"
                  >
                    <div
                      class="sc-gsnTZi TxWJg"
          ...
          <div
            class="sc-hiMGwR ifEzVw"
          >
            body
          </div>
          <div
            class="sc-bczRLJ sc-ehmTmK hQRyqf hqgZvb"
            role="presentation"
          />
        </div>
        <div
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                class="sc-kLLXSd JJfHA"
              >
                <button
                  class="sc-jSMfEi iHPyqh sc-jdAMXn hmHGKz"
                  type="button"
                >
                  <div
                    class="sc-gsnTZi TxWJg"
                  >
                    ...
                    <div
                      class="sc-iBkjds sc-bZnhIo UFfIy hWqhSp"
                      color="text"
                    >
                      /
                    </div>
              ...
              <div
                class="sc-iIPllB ckrkAn"
              >
                <a
                  class="sc-jIZahH hIA-dnZ"
                  href="https://twitter.com/ape_swap"
                  rel="noopener noreferrer"
                  target="_blank"
                >
              ...
              <div
                class="sc-himrzO eednkF"
              >
                <div>
                  <a
                    class="sc-ivTmOn jiACFD"
          ...
          <svg
            class="sc-dkzDqf jbfioX sc-llJcti kNSYzx"
            color="text"
            viewBox="0 0 425 398"
            width="20px"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            class="sc-iBkjds sc-ciZhAO mweal hsFBOL"
            color="text"
          >
