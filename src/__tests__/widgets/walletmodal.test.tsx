    ...
    <DocumentFragment>
      ...
      >
        ...
        >
          ...
          <button class="sc-jSMfEi hcwbMg" id="wallet-connect-" style="justify-content: space-between" type="button">
          <div class="sc-bczRLJ fXIUCw" color="text" font-weight="600">BitKeep</div>
          <svg class="sc-dkzDqf jbfioX" color="text" viewBox="0 0 128 128" width="32px" xmlns="http://www.w3.org/2000/svg">
