  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      ...
      >
        ...
        >
          <div
            class="sc-jRQBWg cApAwU"
            style="height: 90vh; overflow: show;"
          >
            <button
              class="css-1glsfjl-WalletCard css-sd6e39"
              id="wallet-connect-metamask"
            >
              <div
                class="sc-bdvvtL icbzn"
                color="text"
                font-weight="600"
              >
                Metamask
            ...
            <button
              class="css-1glsfjl-WalletCard css-1re5vxp"
      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              class="sc-bdvvtL sc-iCfMLu caCXem bExPLx"
              color="text"
              role="button"
            >
              Copy Address
              <svg
                class="sc-gsDKAQ iteAkp"
                color="text"
                viewBox="0 0 24 24"
                width="20px"
                xmlns="http://www.w3.org/2000/svg"
