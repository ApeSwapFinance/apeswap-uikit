    ...
    <DocumentFragment>
      ...
      >
        ...
        >
          ...
          >
            <h2
              class="sc-bdvvtL sc-hKwDye kJsIyu hapjyu"
              color="text"
              font-weight="800"
            >
              Connect to a wallet
          ...
          <button
            ...
            class="sc-jRQBWg ikYYTr sc-gKclnd bGsNxc"
            type="button"
          >
            <svg
              class="sc-dkPtRN iRMqxI"
              color="primary"
              viewBox="0 0 24 24"
              width="20px"
        ...
        >
          <button
            class="sc-jRQBWg cTthlq"
            id="wallet-connect-metamask"
            style="justify-content: space-between;"
            type="button"
          >
            <div
              class="sc-bdvvtL jelnKi"
              color="text"
              font-weight="600"
            >
              Metamask
          ...
          <a
            class="sc-bdvvtL sc-gsDKAQ iCKKXP cokdGD sc-iqseJM kXQwcx"
            color="primary"
    ...
    <DocumentFragment>
      ...
      >
        ...
        >
          ...
          >
            <a
              class="sc-bdvvtL sc-gsDKAQ fqmUZT cokdGD"
              color="primary"
              font-family="poppins"
            ...
            <div
              class="sc-bdvvtL sc-crHmcD czIbhz kXOzcy"
              color="text"
              role="button"
            >
              Copy Address
